      ...
      <div className="card-container d-flex flex-row flex-wrap">
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              This application was created for foodies with busy schedules, that
              are searching for easy to find recipes for ingredients they have
              in their homes.
            </p>
            <ul>
              <li>
                Retrieves recipes for searched ingredients from the MealsDB API
              </li>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              The Tech Blog is a CMS-style blog site similar to a Wordpress web
              application. Developers can publish blog posts and comment on
